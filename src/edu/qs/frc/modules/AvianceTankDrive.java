...
public class AvianceTankDrive extends AvianceThread{
   ...
   public AvianceTankDrive() {
    ...
    protected void iteration(){
       ...
       boolean EBRAKE = AvianceTankDrive.EBRAKE(Hardware.joystick2.getRawButton(1));
        if(EBRAKE){left_val = 0; right_val = 0;}
        else{
        AvianceTankDrive.JoystickThrottleRight(Hardware.joystick2.getY()); //DO NOT MODIFY
        AvianceTankDrive.JoystickThrottleLeft(Hardware.joystick2.getY());        //DO NOT MODIFY
